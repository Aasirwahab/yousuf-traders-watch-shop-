  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 md:py-20">
      <div className="mb-10 flex items-center justify-between">
        <h2 className="text-[32px] font-normal tracking-[-0.035em] md:text-[40px]">New Article</h2>
        <button className="rounded-full bg-black px-8 py-2.5 text-[13px] text-white transition-colors hover:bg-[#222]">View More</button>
      </div>

      <div className="grid gap-[14px] md:grid-cols-2">
        <article className="group relative min-h-[430px] overflow-hidden rounded-[16px] md:min-h-[440px]">
        ...
        <div className="grid min-h-[430px] gap-[14px] md:min-h-[440px] md:grid-rows-2">
